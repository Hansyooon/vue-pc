<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        <span
          :class="{ username: true, selected: address.id === selectId }"
          @click="selectId = address.id"
...
export default {
  ...
  computed: {
    selectAddress() {
      ...
      return userAddressList
        ? userAddressList.find((address) => address.id === selectId)
        : {};
    },
  },
  methods: {
  ...
  async mounted() {
    ...
    this.selectId = trade.userAddressList.find(

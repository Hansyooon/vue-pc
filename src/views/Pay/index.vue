  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <button class="btn" @click="payQRcode">立即支付</button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    async payQRcode() {
      const QRcodeData = await reqQRcode(this.$route.query.orderId);
      QRCode.toDataURL(QRcodeData.codeUrl)
        .then((url) => {
          this.$alert(`<img src=${url} alt="qrcode"/>`, "请使用微信扫码支付", {
